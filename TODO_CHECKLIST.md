...
- [x] Add TODO items  - Added items to `TODO_CHECKLIST.md` and registered them in the managed todo list.
- [x] Move item in-progress  - Tracked and moved an item to `in-progress` in the managed todo list.
- [x] Mark item done  - Marked an item `completed` in the managed todo list.
